...
## Problema
Muitos usuários desistem de controlar gastos porque os aplicativos atuais exigem muita entrada manual e oferecem pouca personalização.  
A solução proposta é uma experiência conversacional com recomendações automáticas de economia, construída com design inclusivo para atender o maior número de pessoas possível.

## Público-Alvo
- Pessoas que querem começar a organizar suas finanças sem complicação.
- Usuários iniciantes em controle financeiro.
- Pessoas com diferentes perfis e necessidades, incluindo quem depende de recursos de acessibilidade.
